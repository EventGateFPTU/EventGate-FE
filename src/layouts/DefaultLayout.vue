<template>
  <div class="relative">
    <div id="nav" class="relative z-30 flex h-32 items-center justify-between bg-[#fdf6e3] px-24">
      <div class="w-80">
          ...
          <div class="hover:cursor-pointer" @click="$router.push('/my-tickets')">
            ...
            >
              ...
              <path
                ...
                stroke-width="3"
              />
              <path d="M40.708 1.78467V7.13856" stroke="#5AB2FF" stroke-width="3" />
              <path d="M41.1542 10.7078V15.1693" stroke="#5AB2FF" stroke-width="3" />
              <path d="M41.1542 19.6309V24.0924" stroke="#5AB2FF" stroke-width="3" />
              <path d="M41.1542 27.6619V32.1234" stroke="#5AB2FF" stroke-width="3" />
              <path
    ...
    <div class="relative">
      ...
      <div class="relative z-20 h-full min-h-[calc(100vh_-_8rem)] bg-[#fdf6e3]">
        <slot />
      </div>
    </div>
    <div v-if="hasFooter" class="absolute z-10 w-full overflow-hidden">
      <Footer />
    </div>
  </div>
</template>
